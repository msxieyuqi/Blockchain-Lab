...
describe('importPrivateKey', () => {
    it('should work', () => {
        const keypair = (0, importPrivateKey_1.importPrivateKey)(PRIVATE_KEY, test_helpers_1.PolkadotSS58Format.kusama);
        expect(keypair.address).toBe('HSgj13mnepYxuysui2XroHKigftFpQsg1dcSfA9PckdZJW4');
    });
    it('should work', () => {
        const keypair = (0, importPrivateKey_1.importPrivateKey)(PRIVATE_KEY, test_helpers_1.PolkadotSS58Format.polkadot);
