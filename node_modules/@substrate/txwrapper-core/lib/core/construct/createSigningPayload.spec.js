...
describe('createSigningPayload', () => {
    it('should work', () => {
        const signingPayload = (0, createSigningPayload_1.createSigningPayload)((0, test_helpers_1.balancesTransfer)(test_helpers_1.TEST_METHOD_ARGS.balances.transfer, test_helpers_1.TEST_BASE_TX_INFO, test_helpers_1.POLKADOT_25_TEST_OPTIONS), test_helpers_1.POLKADOT_25_TEST_OPTIONS);
