...
describe('decode', () => {
    it('should decode signedTx', async () => {
        const unsigned = (0, test_helpers_1.balancesTransfer)(test_helpers_1.TEST_METHOD_ARGS.balances.transfer, test_helpers_1.TEST_BASE_TX_INFO, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
        ...
        const decoded = (0, decode_1.decode)(signedTx, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
    ...
    it('decodes an unsigned tx', () => {
        const unsigned = (0, test_helpers_1.balancesTransfer)(test_helpers_1.TEST_METHOD_ARGS.balances.transfer, test_helpers_1.TEST_BASE_TX_INFO, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
        const decoded = (0, decode_1.decode)(unsigned, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
    ...
    it('should decode signing payload', () => {
        const unsigned = (0, test_helpers_1.balancesTransfer)(test_helpers_1.TEST_METHOD_ARGS.balances.transfer, test_helpers_1.TEST_BASE_TX_INFO, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
        const signingPayload = __1.construct.signingPayload(unsigned, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
        const decoded = (0, decode_1.decode)(signingPayload, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
