...
describe('decodeSigningPayload', () => {
    it('should decode balances::transfer', () => {
        const signingPayload = __1.construct.signingPayload((0, test_helpers_1.balancesTransfer)(test_helpers_1.TEST_METHOD_ARGS.balances.transfer, test_helpers_1.TEST_BASE_TX_INFO, test_helpers_1.POLKADOT_25_TEST_OPTIONS), test_helpers_1.POLKADOT_25_TEST_OPTIONS);
        const decoded = (0, decodeSigningPayload_1.decodeSigningPayload)(signingPayload, test_helpers_1.POLKADOT_25_TEST_OPTIONS);
